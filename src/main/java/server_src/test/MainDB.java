...
public class MainDB {
	...
	private static ArrayList<Reserva> reses = new ArrayList<Reserva>();
	...
	public static void main(String[] args) {
		...
		System.out.println("estoy dentro de db");
		try
	    {
			System.out.println("estoy dentro de db");
			anyadirUsuario("lander", "pison", "landerp@opendeusto.es");
//			Persona per = new Persona(1111111, "juan", "solozabal");
//			ArrayList<Persona> pasajeros = new ArrayList<Persona>();
//			pasajeros.add(per);
//			anyadirReserva(1, pasajeros);
//			indicarSesionDAO("landerp@opendeusto.es");
//			actualizarUsuario("juansolozabal@gmail.com", "Javier", "Alvarez de Eulate");
...
//		    persistentManager.makePersistent(actu);
	...
	public static void indicarSesionDAO(String correo)
	{
		...
		System.out.println("DAO sabe quien esta en sesion");
	}
